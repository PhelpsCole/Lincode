...
int main() {
    ...
    //randomTestSicles(10, 20, 20, codes::indeep::invariants::invariantHullSize, simplePerm);
    //std::cout << "invariantHullSize for RM" << std::endl;
    //randomTestSiclesRM(2, 4, 20, codes::indeep::invariants::invariantHullSize, simplePerm);

    //std::cout << "invariantWeightHull" << std::endl;
    //randomTestSicles(10, 20, 20, codes::indeep::invariants::invariantWeightHull, simplePerm);
    //std::cout << "invariantWeightHull for RM" << std::endl;
    //randomTestSiclesRM(2, 4, 20, codes::indeep::invariants::invariantWeightHull, simplePerm);

    //std::cout << "invariantWeightBasis" << std::endl;
    //randomTestSicles(20, 64, 20, codes::indeep::invariants::invariantWeightBasis, simplePerm);
    //std::cout << "invariantWeightBasis for RM" << std::endl;
    //randomTestSiclesRM(2, 5, 20, codes::indeep::invariants::invariantWeightBasis, simplePerm);

    //std::cout << "invariantHullHadSquareSize" << std::endl;
    //randomTestSicles(10, 20, 20, codes::indeep::invariants::invariantHullHadSquareSize, mcEliece);
    //std::cout << "invariantHullHadSquareSize for RM" << std::endl;
    //randomTestSiclesRM(3, 6, 20, codes::indeep::invariants::invariantHullHadSquareSize, mcEliece);

    //std::cout << "invariantWeightHullHadSquare" << std::endl;
    //randomTestSicles(10, 20, 20, codes::indeep::invariants::invariantWeightHullHadSquare, mcEliece);
    //std::cout << "invariantWeightHullHadSquare for RM" << std::endl;
    //randomTestSiclesRM(2, 5, 1, codes::indeep::invariants::invariantWeightHullHadSquare, mcEliece);

    std::cout << "invariantWeightHull" << std::endl;
    randomTestSicles(10, 20, 20, codes::indeep::invariants::invariantWeightHull, simplePerm);
    std::cout << "invariantWeightHull RM simple" << std::endl;
    randomTestSiclesRM(3, 7, 1, codes::indeep::invariants::invariantWeightHull, simplePerm);
    //std::cout << "invariantWeightHullBasis for RM" << std::endl;
    //randomTestSiclesRM(2, 5, 20, codes::indeep::invariants::invariantWeightHullBasis, simplePerm);

    //std::cout << "invariantWeightBasis RM equal" << std::endl;
    //randomTestSiclesRM(3, 7, 1, codes::indeep::invariants::invariantWeightBasis, equiv);
    //std::cout << "invariantWeightBasis RM simple" << std::endl;
    randomTestSiclesRM(3, 8, 1, codes::indeep::invariants::invariantWeightBasis, simplePerm);
    ////std::cout << "invariantWeightBasis pqsigRM" << std::endl;
    //randomTestSiclesPqsigRM(3, 7, 10, codes::indeep::invariants::invariantWeightBasis);

    //std::cout << "invariantWeightHullHadSquare RM equal" << std::endl;
    //randomTestSiclesRM(3, 7, 1, codes::indeep::invariants::invariantWeightHullHadSquare, equiv);
    //std::cout << "invariantWeightHullHadSquare RM simple" << std::endl;
    //randomTestSiclesRM(3, 7, 1, codes::indeep::invariants::invariantWeightHullHadSquare, simplePerm);
